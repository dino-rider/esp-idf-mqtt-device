...
struct LastWill {
    std::optional<std::string> lwt_topic;                  /*!< LWT (Last Will and Testament) message topic (NULL by default) */
    std::optional<std::string> lwt_msg;                    /*!< LWT message (NULL by default) */
